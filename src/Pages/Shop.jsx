            ...
            <section className="bg-gray-50 py-8 antialiased md:py-20">
                <div className="mx-auto max-w-7xl px-4 2xl:px-0">
                    ...
                    <div className="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
                        <h2 className="mt-3 text-xl  text-gray-900  sm:text-2xl">All Products</h2>
                        <div className="flex items-center space-x-4">
                            <button data-modal-toggle="filterModal" data-modal-target="filterModal" type="button" className="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm  text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100  sm:w-auto">
                            ...
                            <button id="sortDropdownButton1" data-dropdown-toggle="dropdownSort1" type="button" className="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm  text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100  sm:w-auto">
                                <svg className="-ms-0.5 me-2 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            ...
                            <div id="dropdownSort1" className="z-50 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow dark:bg-gray-700" data-popper-placement="bottom">
                                <ul className="p-2 text-left text-sm  text-gray-500 dark:text-gray-400" aria-labelledby="sortDropdownButton">
                                    <li>
                        ...
                        <div className="relative rounded-lg bg-white shadow dark:bg-gray-800">
                            ...
                            <div className="px-4 md:px-5">
                                <div className="mb-4 border-b border-gray-200 dark:border-gray-700">
                                    <ul className="-mb-px flex flex-wrap text-center text-sm " id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                                ...
                                <div id="myTabContent">
                                    <div className="grid grid-cols-2 gap-4 md:grid-cols-3" id="brand" role="tabpanel" aria-labelledby="brand-tab">
                                        <div className="space-y-2">
                                            <h5 className="text-lg  uppercase text-black dark:text-white">A</h5>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="apple" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Apple (56) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="asus" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Asus (97) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="acer" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Acer (234) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="allview" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Allview (45) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="asus" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Atari (176) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="amd" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> AMD (49) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="aruba" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Aruba (16) </label>
                                            </div>
                                        </div>

                                        <div className="space-y-2">
                                            <h5 className="text-lg  uppercase text-black dark:text-white">B</h5>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="beats" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Beats (56) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="bose" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Bose (97) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="benq" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> BenQ (45) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="bosch" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Bosch (176) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="brother" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Brother (176) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="biostar" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Biostar (49) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="braun" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Braun (16) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="blaupunkt" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Blaupunkt (45) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="benq2" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> BenQ (23) </label>
                                            </div>
                                        </div>

                                        <div className="space-y-2">
                                            <h5 className="text-lg  uppercase text-black dark:text-white">C</h5>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="canon" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Canon (49) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="cisco" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Cisco (97) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="cowon" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Cowon (234) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="clevo" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Clevo (45) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="corsair" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Corsair (15) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="csl" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Canon (49) </label>
                                            </div>
                                        </div>

                                        <div className="space-y-2">
                                            <h5 className="text-lg  uppercase text-black dark:text-white">D</h5>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="dell" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Dell (56) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="dogfish" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Dogfish (24) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="dyson" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Dyson (234) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="dobe" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Dobe (5) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="digitus" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Digitus (1) </label>
                                            </div>
                                        </div>

                                        <div className="space-y-2">
                                            <h5 className="text-lg  uppercase text-black dark:text-white">E</h5>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="emetec" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Emetec (56) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="extreme" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Extreme (10) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="elgato" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Elgato (234) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="emerson" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Emerson (45) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="emi" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> EMI (176) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="fugoo" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Fugoo (49) </label>
                                            </div>
                                        </div>

                                        <div className="space-y-2">
                                            <h5 className="text-lg  uppercase text-black dark:text-white">F</h5>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="fujitsu" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Fujitsu (97) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="fitbit" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Fitbit (56) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="foxconn" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Foxconn (234) </label>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <label for="floston" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Floston (45) </label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4" id="advanced-filters" role="tabpanel" aria-labelledby="advanced-filters-tab">
                                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                                        <div className="grid grid-cols-2 gap-3">
                                            <div>
                                                <label for="min-price" className="block text-sm  text-gray-900 dark:text-white"> Min Price </label>
                                            ...
                                            <div>
                                                <label for="max-price" className="block text-sm  text-gray-900 dark:text-white"> Max Price </label>
                                            ...
                                            <div className="col-span-2 flex items-center justify-between space-x-2">
                                                ...
                                                <div className="shrink-0 text-sm  dark:text-gray-300">to</div>
                                        ...
                                        <div className="space-y-3">
                                            <div>
                                                <label for="min-delivery-time" className="block text-sm  text-gray-900 dark:text-white"> Min Delivery Time (Days) </label>
                                    ...
                                    <div>
                                        <h6 className="mb-2 text-sm  text-black dark:text-white">Condition</h6>

                                        <ul className="flex w-full items-center rounded-lg border border-gray-200 bg-white text-sm  text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                                            <li className="w-full border-r border-gray-200 dark:border-gray-600">
                                                <div className="flex items-center pl-3">
                                                    ...
                                                    <label for="condition-all" className="ml-2 w-full py-3 text-sm  text-gray-900 dark:text-gray-300"> All </label>
                                                </div>
                                            </li>
                                            <li className="w-full border-r border-gray-200 dark:border-gray-600">
                                                <div className="flex items-center pl-3">
                                                    ...
                                                    <label for="condition-new" className="ml-2 w-full py-3 text-sm  text-gray-900 dark:text-gray-300"> New </label>
                                                </div>
                                            </li>
                                            <li className="w-full">
                                                <div className="flex items-center pl-3">
                                                    ...
                                                    <label for="condition-used" className="ml-2 w-full py-3 text-sm  text-gray-900 dark:text-gray-300"> Used </label>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
                                        <div>
                                            <h6 className="mb-2 text-sm  text-black dark:text-white">Colour</h6>
                                            <div className="space-y-2">
                                                <div className="flex items-center">
                                                    ...
                                                    <label for="blue" className="ml-2 flex items-center text-sm  text-gray-900 dark:text-gray-300">
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <label for="gray" className="ml-2 flex items-center text-sm  text-gray-900 dark:text-gray-300">
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <label for="green" className="ml-2 flex items-center text-sm  text-gray-900 dark:text-gray-300">
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <label for="pink" className="ml-2 flex items-center text-sm  text-gray-900 dark:text-gray-300">
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <label for="red" className="ml-2 flex items-center text-sm  text-gray-900 dark:text-gray-300">
                                        ...
                                        <div>
                                            <h6 className="mb-2 text-sm  text-black dark:text-white">Rating</h6>
                                            <div className="space-y-2">
                                                <div className="flex items-center">
                                        ...
                                        <div>
                                            <h6 className="mb-2 text-sm  text-black dark:text-white">Weight</h6>
                                            ...
                                            <div className="space-y-2">
                                                <div className="flex items-center">
                                                    ...
                                                    <label for="under-1-kg" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Under 1 kg </label>
                                                </div>
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <label for="1-1-5-kg" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> 1-1,5 kg </label>
                                                </div>
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <label for="1-5-2-kg" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> 1,5-2 kg </label>
                                                </div>
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <label for="2-5-3-kg" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> 2,5-3 kg </label>
                                                </div>
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <label for="over-3-kg" className="ml-2 text-sm  text-gray-900 dark:text-gray-300"> Over 3 kg </label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <h6 className="mb-2 text-sm  text-black dark:text-white">Delivery type</h6>
                                        ...
                                        <ul className="grid grid-cols-2 gap-4">
                                            <li>
                                                ...
                                                <label for="delivery-usa" className="inline-flex w-full cursor-pointer items-center justify-between rounded-lg border border-gray-200 bg-white p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-600 peer-checked:border-primary-600 peer-checked:text-primary-600 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:peer-checked:text-primary-500 md:p-5">
                                                    <div className="block">
                                                        <div className="w-full text-lg ">USA</div>
                                            ...
                                            <li>
                                                ...
                                                <label for="delivery-europe" className="inline-flex w-full cursor-pointer items-center justify-between rounded-lg border border-gray-200 bg-white p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-600 peer-checked:border-primary-600 peer-checked:text-primary-600 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:peer-checked:text-primary-500 md:p-5">
                                                    <div className="block">
                                                        <div className="w-full text-lg ">Europe</div>
                                                        <div className="w-full">Delivery only for USA</div>
                                                    </div>
                                                </label>
                                            </li>
                                            <li>
                                                ...
                                                <label for="delivery-asia" className="inline-flex w-full cursor-pointer items-center justify-between rounded-lg border border-gray-200 bg-white p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-600 peer-checked:border-primary-600 peer-checked:text-primary-600 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:peer-checked:text-primary-500 md:p-5">
                                                    <div className="block">
                                                        <div className="w-full text-lg ">Asia</div>
                                            ...
                                            <li>
                                                ...
                                                <label for="delivery-australia" className="inline-flex w-full cursor-pointer items-center justify-between rounded-lg border border-gray-200 bg-white p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-600 peer-checked:border-primary-600 peer-checked:text-primary-600 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:peer-checked:text-primary-500 md:p-5">
                                                    <div className="block">
                                                        <div className="w-full text-lg ">Australia</div>
                            ...
                            <div className="flex items-center space-x-4 rounded-b p-4 dark:border-gray-600 md:p-5">
                                <button type="submit" className="rounded-lg bg-primary-700 px-5 py-2.5 text-center text-sm  text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-700 dark:hover:bg-primary-800 dark:focus:ring-primary-800">Show 50 results</button>
                                <button type="reset" className="rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm  text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700">Reset</button>
                            </div>
                        </div>
                    </div>
                </form>
